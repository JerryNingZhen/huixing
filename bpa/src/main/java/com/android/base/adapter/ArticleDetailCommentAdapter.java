 ...
 */
public class ArticleDetailCommentAdapter extends SimpleBaseAdapter<ArticleCommentBean> {


    public ArticleDetailCommentAdapter(Context context, ArrayList<ArticleCommentBean> data) {
        super(context, data);
    }
    ...
    public View getItemView(final int position, View convertView, ViewHolder holder) {
        ...
        txt_hf.setVisibility(View.GONE);
        txt_dz.setVisibility(View.GONE);
