...
public class TitleView extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        txt_title = (TextView) viewParent.findViewById(R.id.txt_title_top);
        txt_title2 = (TextView) viewParent.findViewById(R.id.txt_title_top2);
    }
    ...
    public void setBgColor(int bgColor, int textColor) {
        viewParent.setBackgroundColor(bgColor);
        txt_title.setTextColor(textColor);
        txt_title2.setTextColor(textColor);
        txt_right.setTextColor(textColor);
        txt_left.setTextColor(textColor);
    }
