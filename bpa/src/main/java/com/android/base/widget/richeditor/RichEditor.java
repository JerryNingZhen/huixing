package com.android.base.widget.richeditor;
...
public class RichEditor extends WebView {
    ...
    private void readHtmlFormAssets() {
        ...
        removeJavascriptInterface("searchBoxJavaBridge_");//移除该JavaScript接口
        removeJavascriptInterface("accessibility");
        removeJavascriptInterface("accessibilityTraversal");
        webSettings.setSavePassword(false);     //关闭密码保存提醒功能
        webSettings.setAllowFileAccess(true);  //通过以下设置，防止越权访问，跨域等安全问题：
