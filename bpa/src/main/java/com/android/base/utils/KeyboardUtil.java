...
public class KeyboardUtil {
    ...
    //            @Override
    //            public void onActivityDestroyed(Activity baseUI) {
    //
    //            }
    //
    //            @Override
    //            public void onActivityStarted(Activity baseUI) {
    //
    //            }
    //
    //            @Override
    //            public void onActivityResumed(Activity baseUI) {
    //
    //            }
    //
    //            @Override
    //            public void onActivityPaused(Activity baseUI) {
    //
    //            }
    //
    //            @Override
    //            public void onActivityStopped(Activity baseUI) {
    //
    //            }
    //
    //            @Override
    //            public void onActivitySaveInstanceState(Activity baseUI, Bundle bundle) {
    //
    //            }
    //
    //            @Override
    //            public void onActivityCreated(Activity baseUI, Bundle savedInstanceState) {
    //                ReferenceCleaner cleaner = new ReferenceCleaner(imm, mHField, mServedViewField, finishInputLockedMethod);
    //                View rootView = baseUI.getWindow().getDecorView().getRootView();
    ...
    //                            Activity baseUI = extractActivity(servedView.getContext());
    //                            if (baseUI == null || baseUI.getWindow() == null) {
    //                                // Unlikely case. Let's finish the input anyways.
    //                                finishInputLockedMethod.invoke(imm);
    //                            } else {
    //                                View decorView = baseUI.getWindow().peekDecorView();
