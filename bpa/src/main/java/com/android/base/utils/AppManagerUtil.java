...
public class AppManagerUtil {
    ...
    public void removeActivity(Activity activityRemove) {
        if (null != activityStack && activityStack.size() > 0) {
            if (activityStack.contains(activityRemove)) {
                ...
                // baseUI.finish(); 该方法在onDestroy内调用 无需再调finish方法
            }
        }
    }
    ...
    //     *         指定的Activity
    //     */
    //    private void finishActivity(Activity baseUI) {
    //        if (baseUI != null) {
    //            activityStack.remove(baseUI);
    //            // IntentUtil.finish(baseUI);
    //        }
    //    }
    //    /**
    ...
    //        for (Activity baseUI : activityStack1) {
    //            if (baseUI.getClass().equals(cls)) {
    //                return true;
    //            }
    //        }
    //
