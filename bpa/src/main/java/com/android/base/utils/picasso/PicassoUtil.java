package com.android.base.utils.picasso;
...
public class PicassoUtil {
     ...
     */
    public static void loadImage(Context context, String imgPath, ImageView imageView, int resDefaultId, int resErrorId, Transformation transformation) {
        ...
        try {
            if (imgPath.contains("storage/emulated")) {
                requestCreator = Picasso.with(context).load(new File(imgPath));//
            } else {
                requestCreator = Picasso.with(context).load(imgPath);//
            }
