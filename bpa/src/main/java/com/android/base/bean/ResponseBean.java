...
public class ResponseBean extends BaseBean {
    ...
    protected void init(JSONObject jSon) {
        status = jSon.optString(ConfigServer.RESULT_JSON_STATUS, "");
        info = jSon.optString(ConfigServer.RESULT_JSON_INFO, "");
        object = jSon.optString(ConfigServer.RESULT_JSON_DATA, "");
    }
