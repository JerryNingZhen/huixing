...
public class RecomendFragment extends BaseFragment {
        ...
        RetrofitUtils.getInstance().normalGet(Constant.BASE_URL + Nets.quaryReviewByUser, map, new JsonCallBack() {
            ...
            public void next(String response) {
                ...
                if (articles.size() > 0){
                    ...
                    RecomendFragmentPermissionsDispatcher.showPermissionWithPermissionCheck(RecomendFragment.this);
                }
                mAdapter.notifyDataSetChanged();
    ...
    void showPermission() {
        ...
        FileUtil.deleteFolderFile(ConfigFile.PATH_LOG + "recomend", true);
        FileUtil.writeObject(ConfigFile.PATH_LOG + "recomend/","CareFragment.txt", listDatas);
    }

    @Override
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
        RecomendFragmentPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
