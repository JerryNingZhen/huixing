...
public class ArrowDrawable extends PaintDrawable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (mWidth != width || mHeight != height) {
            ...
            float vector1 = (float) (lineWidth * Math.sin(Math.PI/6));
            float vector2 = (float) (lineWidth / Math.sin(Math.PI/6));
            mPath.moveTo(width / 2, height);
            mPath.lineTo(width/4, height / 2);
            mPath.lineTo(width/4+vector1, height / 2 - vector1);
            mPath.lineTo(width / 2 - lineWidth / 2, height - vector2 - lineWidth / 2);
            mPath.lineTo(width / 2 - lineWidth / 2, 0);
            mPath.lineTo(width / 2 + lineWidth / 2, 0);
            mPath.lineTo(width / 2 + lineWidth / 2, height - vector2 - lineWidth / 2);
            mPath.lineTo(width-width/4 - vector1, height / 2 - vector1);
            mPath.lineTo(width-width/4, height / 2);
            mPath.close();
