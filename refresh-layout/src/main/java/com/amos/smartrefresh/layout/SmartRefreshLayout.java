package com.amos.smartrefresh.layout;
...
import com.amos.smartrefresh.layout.api.DefaultRefreshFooterCreator;
import com.amos.smartrefresh.layout.api.DefaultRefreshHeaderCreator;
import com.amos.smartrefresh.layout.api.RefreshContent;
import com.amos.smartrefresh.layout.api.RefreshFooter;
import com.amos.smartrefresh.layout.api.RefreshHeader;
import com.amos.smartrefresh.layout.api.RefreshInternal;
import com.amos.smartrefresh.layout.api.RefreshKernel;
import com.amos.smartrefresh.layout.api.RefreshLayout;
import com.amos.smartrefresh.layout.api.ScrollBoundaryDecider;
import com.amos.smartrefresh.layout.constant.DimensionStatus;
import com.amos.smartrefresh.layout.constant.RefreshState;
import com.amos.smartrefresh.layout.constant.SpinnerStyle;
import com.amos.smartrefresh.layout.footer.ClassicsFooter;
import com.amos.smartrefresh.layout.header.ClassicsHeader;
import com.amos.smartrefresh.layout.impl.RefreshContentWrapper;
import com.amos.smartrefresh.layout.impl.RefreshFooterWrapper;
import com.amos.smartrefresh.layout.impl.RefreshHeaderWrapper;
import com.amos.smartrefresh.layout.listener.OnLoadMoreListener;
import com.amos.smartrefresh.layout.listener.OnMultiPurposeListener;
...
import com.amos.smartrefresh.layout.listener.OnStateChangedListener;
import com.amos.smartrefresh.layout.util.DelayedRunnable;
import com.amos.smartrefresh.layout.util.DensityUtil;
import com.amos.smartrefresh.layout.util.ScrollBoundaryUtil;
import com.amos.smartrefresh.layout.util.ViscousFluidInterpolator;
...
import static com.amos.smartrefresh.layout.util.DensityUtil.dp2px;
import static com.amos.smartrefresh.layout.util.SmartUtil.fling;
import static com.amos.smartrefresh.layout.util.SmartUtil.getColor;
import static com.amos.smartrefresh.layout.util.SmartUtil.isScrollableView;
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    protected boolean mEnableFooterFollowWhenLoadFinished = true;//是否在全部加载结束之后Footer跟随内容 1.0.4-6
    ...
    public boolean mFooterNoMoreData = false;//数据是否全部加载完成，如果完成就不能在触发加载事件
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.amos.smartrefresh.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.amos.smartrefresh.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
