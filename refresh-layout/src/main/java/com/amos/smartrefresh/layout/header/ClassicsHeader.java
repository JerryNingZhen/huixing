package com.amos.smartrefresh.layout.header;
...
import com.amos.smartrefresh.layout.R;
...
import com.amos.smartrefresh.layout.internal.ArrowDrawable;
import com.amos.smartrefresh.layout.internal.InternalClassics;
import com.amos.smartrefresh.layout.internal.ProgressDrawable;
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTitle, DensityUtil.sp2px(14)));
        } else {
            mTitleText.setTextSize( (14));
        }

        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTime, DensityUtil.sp2px(12)));
        } else {
